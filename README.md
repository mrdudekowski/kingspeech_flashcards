...
- [**Последние изменения**](./docs/RECENT_CHANGES.md) - новые функции и исправления
- [**Следующие шаги**](./docs/NEXT_STEPS.md) - план дальнейшей разработки

## План разработки MVP

- [**Общий план MVP**](./docs/image/future.plans/stages/MVP_PLAN.md) - все этапы разработки
- [Отслеживание этапов](./docs/image/future.plans/stages/README.md) - детальные чекпойнты для каждого этапа
